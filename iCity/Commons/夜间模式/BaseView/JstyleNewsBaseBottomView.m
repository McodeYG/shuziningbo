...
#import "JstyleNewsBaseBottomView.h"

@implementation JstyleNewsBaseBottomView
...
- (void)applyTheme {
    self.backgroundColor = ISNightMode?JSColor(@"868686"):kWhiteColor;
}
