...
#import "JstyleNewsBaseLineView.h"

@implementation JstyleNewsBaseLineView
...
- (void)applyTheme {
    self.backgroundColor = ISNightMode?kDarkThreeColor:kSingleLineColor;
}
