//
//  JstyleNewsDailySingInTypeTwoView.m
//  JstyleNews
//
...
#define Margin_Left     26.5
#define Margin_Bottom   39
#define Margin_PosterHeight   36
#define Margin_PictureHeight 464.0

@implementation JstyleNewsDailySingInTypeTwoView
...
- (UIImage *)renderShareImage {
    ...
    CGContextTranslateCTM(UIGraphicsGetCurrentContext(), Margin_Left, (Margin_PictureHeight - 31) - posterImageViewHeight + (kScale == 1?0:50.5));
