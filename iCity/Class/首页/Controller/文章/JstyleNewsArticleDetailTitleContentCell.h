...
@interface JstyleNewsArticleDetailTitleContentCell : JstyleNewsBaseTableViewCell

///订阅按钮
@property (weak, nonatomic) IBOutlet JstyleNewsBaseAttentionButton *subscribeButton;
