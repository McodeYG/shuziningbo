//
//  JstyleNewsJMAttentionLeftViewCell.m
//  JstyleNews
//
...
@implementation JstyleNewsJMAttentionLeftViewCell
...
- (void)setSelected:(BOOL)selected animated:(BOOL)animated {
    ...
    if (selected) {
        ...
        _nameLabel.textColor = ISNightMode?kWhiteColor:kDarkNineColor;
        _nameLabel.backgroundColor = ISNightMode?kDarkThreeColor:kBackGroundColor;
    }
}
