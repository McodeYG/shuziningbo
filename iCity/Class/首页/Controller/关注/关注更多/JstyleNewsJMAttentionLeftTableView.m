//
//  JstyleNewsJMAttentionLeftTableView.m
//  JstyleNews
//
...
@interface JstyleNewsJMAttentionLeftTableView()<UITableViewDelegate, UITableViewDataSource>

@end

@implementation JstyleNewsJMAttentionLeftTableView
