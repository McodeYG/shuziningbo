//
//  RepositoryCollectionViewCell.m
//  iCity
//
...
@interface RepositoryCollectionViewCell()
...
- (void)setupUI {
    ...
    UILabel *descLabel = [UILabel labelWithColor:kWhiteColor fontSize:10 text:@"0资源丨0关注" alignment:NSTextAlignmentCenter];
