...
//
    ...
    _textView = [[UITextView alloc]initWithFrame:CGRectMake(10, 54, kScreenWidth-20, 170)];
    ...
    _characterLabel = [[UILabel alloc]initWithFrame:CGRectMake(kScreenWidth - 60, CGRectGetMaxY(_textView.frame) - 12, 55, 12)];
