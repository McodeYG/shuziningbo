...
- (void)setupNavigationItem {
    ...
    [left_Button setImage:JSImage(@"文章返回黑") forState:UIControlStateNormal];
//    [left_Button setTitleColor:[UIColor colorWithRed: 21/ 255.0f green: 126/ 255.0f blue: 251/ 255.0f alpha:1.0] forState:(UIControlStateNormal)];
    ...
    UIBarButtonItem *rightItem = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:(UIBarButtonSystemItemRefresh) target:self action:@selector(right_BarButtonItemAction)];
    [rightItem setTintColor:kDarkOneColor];
