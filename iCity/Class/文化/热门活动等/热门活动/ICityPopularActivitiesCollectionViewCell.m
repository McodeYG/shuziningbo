//
//  ICityPopularActivitiesCollectionViewCell.m
//  iCity
//
...
@interface ICityPopularActivitiesCollectionViewCell()
...
@implementation ICityPopularActivitiesCollectionViewCell
...
- (void)setModel:(ICityCultureReuseModel *)model {
    ...
    [self.posterImageView setImageWithURL:[NSURL URLWithString:model.image] placeholder:SZ_Place_F_T];
