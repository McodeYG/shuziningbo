...
//设置标签数据和代理
- (void)setTagsArray:(NSArray *)tagAry delegate:(id)delegate {
...
- (void)buttonAction:(UIButton *)sender {
    if (self.tagDelegate && [self.tagDelegate respondsToSelector:@selector(tagsViewButtonAction:button:)]) {
        [self.tagDelegate tagsViewButtonAction:self button:sender];
    }
}
