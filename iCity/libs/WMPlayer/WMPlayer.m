...
@property (nonatomic, assign) NSUInteger videoNextNum;
...
//    }];
    ...
    [self.playOrPauseBtn setImage:[UIImage imageNamed:@"videopause"] forState:UIControlStateNormal];
    [self.playOrPauseBtn setImage:[UIImage imageNamed:@"videoplay"] forState:UIControlStateSelected];
    ...
    self.progressSlider.minimumTrackTintColor = kGlobalGoldColor;
    self.progressSlider.maximumTrackTintColor = kDarkNineColor;
    ...
    .leftSpaceToView(self.bottomView, -3)
    .rightSpaceToView(self.bottomView, -3)
...
//    [self.bottomView addSubview:self.loadingProgress];
    ...
    self.loadingProgress.sd_layout
...
//    [self.bottomView sendSubviewToBack:self.loadingProgress];
    ...
    [self.fullScreenBtn setImage:[UIImage imageNamed:@"视频全屏"] forState:UIControlStateNormal];
    [self.fullScreenBtn setImage:[UIImage imageNamed:@"视频全屏"] forState:UIControlStateSelected];
    ...
    .topSpaceToView(self.playOrPauseBtn, 0)
    .centerXEqualToView(self.bottomView)
    .widthIs(5)
    .heightIs(20);
    ...
    self.rightTimeLabel.text = [self convertTime:0.0];
...
//    [self.contentView addGestureRecognizer:singleTap];
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(videoNext:) name:@"VideoNext" object:nil];
}

- (void)videoNext:(NSNotification *)notification
{
    self.videoNextNum = [notification.userInfo[@"videoNext"] integerValue];
    if (self.videoNextNum == 1) {
        [self fullScreen];
    }else{
        [self smallScreen];
    }
